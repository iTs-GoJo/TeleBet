...
🎲 شرط‌بندی:
  /bet <مقدار> <زوج/فرد> - ثبت شرط

🎁 هدایا:
  /gift <gift_name> - استفاده از هدیه

💹 ارز دیجیتال:
  /crypto list - لیست ارزها
  /crypto buy <name> <amount> - خرید ارز مورد نظر
  /crypto sell <name> <amount> - فروش ارز مورد نظر
  /crypto price <name> - قیمت ارز مورد نظر
  /top digi - لیدربورد ارز دیجیتال

🪙 طلا:
  /gold price - قیمت فعلی طلا
  /gold buy <amount> - خرید طلا
  /gold sell <amount> - فروش طلا
  /top gold - لیدربورد طلا

🎨 ان‌اف‌تی:
  /nft list - لیست ان‌اف‌تی ها
  /nft buy <name> - خرید ان‌اف‌تی
  /nft sell <name> [price] - فروش ان‌اف‌تی
  /nft portfolio - نمایش NFT های شما
  /top nft - لیدربورد NFT

🏦 بانک و وام:
  /bank de <مقدار> - واریز به بانک
  /bank wi <مقدار> - برداشت از بانک
  /bank ln <مقدار> - دریافت وام (حداکثر 1,000,000)
  /bank pr - پرداخت وام
  💸 نکته: وام‌ها با کارمزد 9٪ در صورت عدم پرداخت واریز از بانک کم می‌شوند

💫 استارز (Stars):
  /stars buy <مقدار> - خرید Stars با امتیاز
  /stars sell <مقدار> - فروش Stars به امتیاز
  /stars price - مشاهده قیمت فعلی هر استارز (هر دقیقه تغییر می‌کند)

📊 امتیاز و لیدربورد:
  /score - مشاهده امتیاز فعلی شما
  /top rate - لیدربورد امتیازات
